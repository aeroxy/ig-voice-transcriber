...
/**
 * The extension's only settings surface: how many transcripts are cached, a way
 * to drop them, and how long to wait for one.
 *
 ...
 * between the user and a fresh answer — and the per-clip control re-shows a
 * cached transcript rather than remaking it.
 */
