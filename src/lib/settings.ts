 ...
 * minute one is a megabyte of audio to download from the CDN, upload to
 * QuillBot, and a great deal more to recognise. A default low enough to fail
 * fast on a hung request is therefore too low for somebody's long clips, and
